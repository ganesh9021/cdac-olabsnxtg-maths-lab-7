...
function DragnDrop_4() {
  let navigate = useNavigate();

  const Next_Res = () => {
    navigate("/activity1/letusverify/act1startpage/lhs_rhs/tool_4/dragndrop_4/res_4");
  };
  const canvas = useRef();
  ...
  const boxes = [
    ...
    { x: 268, y: 100, r: 50, s: 0, e: 2 * Math.PI, shapeName: "B" },
